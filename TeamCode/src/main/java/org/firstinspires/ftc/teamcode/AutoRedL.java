...
@Autonomous(name="A_Red - Left", group="Pushbot")
public class AutoRedL extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if (vuMark != RelicRecoveryVuMark.UNKNOWN) {
                ...
                if (vuMark == RelicRecoveryVuMark.LEFT) {
                    ...
                    //MERGERE INAINTE PENTRU A IMINGE
                    robot.motorA1.setPower(-0.25);
                    robot.motorA2.setPower(0.25);
                    robot.motorB1.setPower(0.25);
                    robot.motorB2.setPower(-0.25);
                ...
                if (vuMark == RelicRecoveryVuMark.CENTER) {
                  ...
                  if (robot.colorSensor.red() > robot.colorSensor.blue()) {
                    ...
                    robot.motorB1.setPower(0.25);
                    robot.motorB2.setPower(-0.25);
                    sleep(1100);//stay here for 1 second,don't move to next instructions
                    ...
                    //MERGERE INAINTE PENTRU A IMPINGE
                    robot.motorA1.setPower(-0.25);
                    robot.motorA2.setPower(0.25);
                    robot.motorB1.setPower(0.25);
                    robot.motorB2.setPower(-0.25);
