...
@Autonomous(name="SCAN_x", group="Pushbot")
@Disabled
public class ScanareInit extends LinearOpMode {
            ...
            if (vuMark != RelicRecoveryVuMark.UNKNOWN) {
                ...
                if (vuMark == RelicRecoveryVuMark.CENTER) {
                  ...
                  if (robot.colorSensor.red() > robot.colorSensor.blue()) {
                    ...
                    robot.motorB1.setPower(0.25);
                    robot.motorB2.setPower(-0.25);
                    sleep(1640);//stay here for 1 second,don't move to next instructions
                ...
                if (vuMark == RelicRecoveryVuMark.LEFT) {
                    ...
                    robot.motorB1.setPower(0.25);
                    robot.motorB2.setPower(-0.25);
                    sleep(1850);//stay here for 1 second,don't move to next instructions
