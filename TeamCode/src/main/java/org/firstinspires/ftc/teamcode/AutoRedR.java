...
@Autonomous(name="A_Red - Right", group="Pushbot")
   ...
   s                 */
                ...
                if (vuMark == RelicRecoveryVuMark.CENTER) {
                  ...
                  if (robot.colorSensor.red() > robot.colorSensor.blue()) {
                    ...
                    robot.motorB1.setPower(0.25);
                    robot.motorB2.setPower(-0.25);
                    sleep(1400);//stay here for 1 second,don't move to next instructions
                ...
                if (vuMark == RelicRecoveryVuMark.LEFT) {
                    ...
                    robot.motorB1.setPower(0.25);
                    robot.motorB2.setPower(-0.25);
                    sleep(1750);//stay here for 1 second,don't move to next instructions
